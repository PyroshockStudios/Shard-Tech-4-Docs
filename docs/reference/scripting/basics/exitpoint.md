...
[AppInstance](../modules/sdt4.managed.core/appinstance.md).RequestAppExit() returns a exit code, if the application can be terminated. In most circumstances it will always return [AppExitRequest](../modules/sdt4.managed.core/appexitrequest.md).Success. In other cases, 
...
await request = instance.RequestAppExit();
