...
## Defining the entry
An entry point is expected to be defined as `Game.OnInit`, where `OnInit` is a static method with [AppLoadContext](../../../cs-api-ref/sdt4.managed.core/apploadcontext.md) as its
...
The [AppLoadContext](../../../cs-api-ref/sdt4.managed.core/apploadcontext.md) is a data structure containing asynchronous Task objects. 
...
The [AppInstance](../../../cs-api-ref/sdt4.managed.core/appinstance.md) holds the heart of the engine, which can be used for loading resources, gathering inputs, and start network connections. Below is an example on how to do make use of the asynchronous task using modern C# _async_ and _await_: 
