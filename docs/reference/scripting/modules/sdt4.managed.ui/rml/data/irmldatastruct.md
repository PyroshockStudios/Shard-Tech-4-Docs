...
Called when the data model updates the variable with name <paramref name="memberName" /> directly. This is <strong>NOT</strong> called when a member has its variable updated.
