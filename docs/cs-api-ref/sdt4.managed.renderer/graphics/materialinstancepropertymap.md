...
---
#### public [Void](https://learn.microsoft.com/dotnet/api/system.void) SetParameter([String](https://learn.microsoft.com/dotnet/api/system.string) name, [Texture2DAsset](../../sdt4.managed.core/asset/texture2dasset.md) value)

**Parameters:**

- `name` ([String](https://learn.microsoft.com/dotnet/api/system.string)): 

- `value` ([Texture2DAsset](../../sdt4.managed.core/asset/texture2dasset.md)): 
